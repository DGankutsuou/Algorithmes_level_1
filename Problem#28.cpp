...
unsigned int sumOddNumbersFrom1toN_usingForStatment(unsigned int n){
...
unsigned int sumOddNumbersFrom1toN_usingWhileStatment(unsigned int n){
    unsigned int oddNumbers = 0;
...
unsigned int sumOddNumbersFrom1toN_usingDoWhileStatment(unsigned int n){
    unsigned int oddNumbers = 0;
    unsigned int counter = 1;
    do{
        if(check_number_odd_or_even(counter) == en_Odd_Even::Odd){
...
int main()
{
    ...
    printResults(sumOddNumbersFrom1toN_usingForStatment(number));
    printResults(sumOddNumbersFrom1toN_usingWhileStatment(number));
    printResults(sumOddNumbersFrom1toN_usingDoWhileStatment(number));
